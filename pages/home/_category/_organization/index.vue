...
export default {
    ...
    methods: {
        subscribeNow: function() {
            if (!this.subscribe) {
                this.$repository.organization.create(this.organization.id,this.user.id).then(response => {
...
<style lang="scss">
@import '../../../../assets/favorite/favorite.scss';
@import '../../../../assets/organization/organization.scss';
</style>
