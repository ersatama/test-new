        ...
        <div class="container pb-5 px-0">
            <div class="row mb-5">
                <div class="col-12 col-md-6 col-lg-3">
                    <h5 class="font-weight-bold mt-3 mt-md-0">Ссылки reserved</h5>
                    <ul class="list-group p-0 mt-md-4 footer-menu-group">
                        <li class="list-group-item bg-transparent border-0 px-0 py-1 py-md-2">
                            <router-link to="/form" class="p-0 m-0 text-white">Для ресторанов</router-link>
                        </li>
                        <li class="list-group-item bg-transparent border-0 px-0 py-1 py-md-2">
                            <router-link to="/contacts" class="p-0 m-0 text-white">Контакты</router-link>
                        </li>
                        <li class="list-group-item bg-transparent border-0 px-0 py-1 py-md-2">
                            <router-link to="/support" class="p-0 m-0 text-white">Поддержка</router-link>
                        </li>
                    </ul>
                </div>
<!--                <div class="col-12 col-md-6 col-lg-3">
...
<h6 class="mt-3 footer-title-sub">Скачайте приложение</h6>
                    ...
                    <h6 class="pt-1 mt-md-0 footer-company">©  Reserved 2020 - 2021</h6>
                </div>
            </div>
        </div>
    </div>
